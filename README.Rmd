...
To view color palettes for college teams, use the `show_ncaa_col()` function [^ncaa]. 

[^ncaa]: Note that hexcodes are only available for 248 of 353 Division I teams.
